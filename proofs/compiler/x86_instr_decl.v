...
Definition Ox86_ADDSD_instr :=
  mk_instr_pp "ADDSD" (w2_ty U128 U128) (w_ty U128) [:: Eu 0; Eu 1] [:: Eu 0] MSB_CLEAR x86_ADDSD
    [:: [:: xmm; xmm ] ] 2 (primM ADDSD) (pp_name_ty "addsd" [::U128;U128]).

Definition Ox86_SUBSD_instr :=
  mk_instr_pp "SUBSD" (w2_ty U128 U128) (w_ty U128) [:: Eu 0; Eu 1] [:: Eu 0] MSB_CLEAR x86_SUBSD
    [:: [:: xmm; xmm] ] 2 (primM SUBSD) (pp_name_ty "subsd" [::U128;U128]).

Definition Ox86_MULSD_instr :=
  mk_instr_pp "MULSD" (w2_ty U128 U128) (w_ty U128) [:: Eu 0; Eu 1] [:: Eu 0] MSB_CLEAR x86_MULSD
    [:: [:: xmm; xmm] ] 2 (primM MULSD) (pp_name_ty "mulsd" [::U128;U128]).

(*
Definition Ox86_CMPSD_instr :=
  mk_instr_pp "CMPSD" (w2w8_ty U128) (w_ty U128) [:: Eu 0; Eu 1; Ea 2] [:: Eu 0] MSB_CLEAR x86_CMPSD
    [:: [:: xmm; xmm; i U8 ] ] 3 (primM CMPSD) (pp_name "cmpsd").
*)
Definition Ox86_CMPSD_instr :=
  mk_instr_pp "CMPSD" (w2w8_ty U128) (w_ty U128) [:: Eu 0; Eu 1; Ea 2] [:: Eu 0] MSB_CLEAR x86_CMPSD
...
Definition Ox86_CVTSI2SD_instr :=
  mk_instr_w_w128_10 "CVTSI2SD" MSB_CLEAR x86_CVTSI2SD (λ _, [:: [:: xmm; r ] ]) (prim_32_64 CVTSI2SD) size_32_64 (pp_movd "cvtsi2sd").

Definition Ox86_CVTSD2SI_instr :=
  ( λ sz, mk_instr_safe (pp_s "CVTSD2SI") (w128_ty) (w_ty sz) [:: Eu 1 ] [:: Eu 0 ] MSB_CLEAR (x86_CVTSD2SI sz) [:: [:: r; xmm ] ] 2 (size_32_64 sz) (pp_movd "cvtsd2si" sz)
  , ("CVTSD2SI"%string, prim_32_64 CVTSD2SI) ).

Definition Ox86_CVTTSD2SI_instr :=
  ( λ sz, mk_instr_safe (pp_s "CVTTSD2SI") (w128_ty) (w_ty sz) [:: Eu 1 ] [:: Eu 0 ] MSB_CLEAR (x86_CVTTSD2SI sz) [:: [:: r; xmm ] ] 2 (size_32_64 sz) (pp_movd "cvttsd2si" sz)
