...
Definition Ox86_ROUNDSD_instr :=
  mk_instr_pp "ROUNDSD" (ww8_ty U128) (w_ty U128) [:: Eu 0; Ea 1] [:: Eu 0] MSB_MERGE x86_ROUNDSD
    [:: [:: xmm; i U8] ] 2 (primM ROUNDSD) (fun args => {| pp_aop_name := "roundsd"; pp_aop_ext := PP_name; pp_aop_args := zip [:: U128; U128; U8] args; |} ).
